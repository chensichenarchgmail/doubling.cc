...
const state = {
  ...
  portfolio: JSON.parse(localStorage.getItem("doubling-portfolio") || "[]"),
  abilities: JSON.parse(localStorage.getItem("doubling-abilities") || "[]"),
